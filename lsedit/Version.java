...
public class Version {
	...
	public final static String COMPILED = "27th April, 2018";
	...
	public static String authorsAndCopyright()
	{
		...
		result	= Version.Number() + "\n\n" + Version.CompileDate() + "\n"
		        + "Developed at the University of Toronto under the supervision of Prof. Ric Holt\n"
			+ "Ric Holt owns this software\n" 
		        + "Original Author: Gary Farmaner\n"
		        + "Enormously enhanced at the University of Waterloo by Ian Davis\n";
...
7.4.2
 ...
 1 Changed to use classpath when invoking external java
 */
