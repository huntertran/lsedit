...
public class NavNext_Button extends ToolBarButton
{
	protected static final String description = "Go to next landscape";
	...
	public NavNext_Button(ToolBarEventHandler teh) 
	{
		super(teh);
		setKeystroke(Event.CTRL_MASK, Do.NAV_NEXT);
	}
}
