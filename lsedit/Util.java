...
//	static boolean first = true;
    ...
    public static String javaCommandString = null;

	public static String javaCommand()
	{
		if (javaCommandString == null) {
			String classpath = System.getProperty("java.class.path");
			String home      = System.getProperty("java.home");
			String os        = System.getProperty("os.name");

			javaCommandString = home + "/bin/java";
			if (!os.equals("Linux")) {
				javaCommandString += ".exe";
			}
			javaCommandString += " -classpath " + classpath + " ";
		}
		return javaCommandString;
	}
...
*/
	...
	public static boolean drawStringBottomClipped(Graphics g, String str, double x, double y, double width, double height, boolean centered, boolean underlined, boolean invertBackground)
	{
		...
		return drawStringClipped(g, str, x, y+height-fontHeight, width, fontHeight, centered, underlined, invertBackground);
	}
