...
public class BrowserLauncher {
	...
	public static final int JVM_UNKNOWN = -2;	/** JVM constant for uninitialised */
	public static final int OTHER       = -1;	/** JVM constant for any other platform */
	public static final int MRJ_2_0     = 0;	/** JVM constant for MRJ 2.0 */
	public static final int MRJ_2_1     = 1;	/** JVM constant for MRJ 2.1 or later */
	public static final int MRJ_3_0     = 3;	/** JVM constant for Java on Mac OS X 10.0 (MRJ 3.0) */
	public static final int MRJ_3_1     = 4;	/** JVM constant for MRJ 3.1 */
	public static final int WINDOWS_NT  = 5;	/** JVM constant for any Windows NT JVM */
	public static final int WINDOWS_9x  = 6;	/** JVM constant for any Windows 9x JVM */
	...
	private static int jvm = JVM_UNKNOWN;
